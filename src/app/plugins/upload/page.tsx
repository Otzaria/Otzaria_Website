...
export default function UploadPluginPage() {
  ...
  const [companion, setCompanion] = useState(() => companionFormFromPublic(null))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const companionError = validateCompanionForm(companion, { hasFile: Boolean(companionFile), hasExisting: false })
      if (companionError) {
