...
const RULES = [
  ...
  'שומר-דף: אם בתמונת המספר מופיעה מילה ולא מספר — זו המילה הראשונה של העמוד הבא, שנהגו להדפיס בתחתית העמוד. לחצו "זו מילה — שומר-דף".',
  'כותרת רצה: הכותרת החוזרת בראש כל עמוד (שם הספר/המסכת). אם התיבה הכתומה לא עוטפת אותה — גררו ותקנו; אם אין כותרת בעמוד — סמנו זאת. כותרת חד-פעמית ("פרק שני") היא תוכן — לא כותרת רצה.',
  'חלוקת זרמים: הרצועות הצבעוניות מפרידות בין אזורי הטקסט (פנים, הערות וכדומה). גררו את הגבולות למקום המדויק ובחרו לכל רצועה את זהותה מהמקרא. חסרה רצועה? "הוסף רצועה" ותקנו את הגבול; רצועה שאין לה זרם במקרא — "לא משויך".',
  'כותרת של זרם ("הגהות" וכדומה) שייכת לתוך הרצועה של הזרם שלה, בראשה — לא לרצועה שמעליה.',
  'שני טורים של אותו טקסט (ימני ואז שמאלי) = רצועה אחת. הערות-שוליים צרות בצד העמוד — התעלמו מהן; הרצועות מתייחסות לגוף העמוד בלבד.',
  'ספק = דילוג: אם העמוד לא ברור (סריקה פגומה, טורים מקבילים של טקסטים שונים, מבנה מוזר) — לחצו "דלג" ותקבלו עמוד אחר. עדיף לדלג מלנחש.',
