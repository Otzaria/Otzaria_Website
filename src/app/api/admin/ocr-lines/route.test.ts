...
const { getServerSessionMock, findMock, countDocumentsMock, aggregateMock } = vi.hoisted(() => ({
...
function makeRequest(url = "http://localhost/api/admin/ocr-lines") {
  return { url } as Request;
}

describe("GET /api/admin/ocr-lines", () => {
  beforeEach(() => {
  ...
  it("returns 200 with the line list for an admin_ocr session", async () => {
