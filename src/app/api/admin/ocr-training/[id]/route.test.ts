...
const { getServerSessionMock, revalidateTagMock } = vi.hoisted(() => ({
...
vi.mock("@/models/OcrTrainingPage", () => ({ default: {} }));
...
describe("DELETE /api/admin/ocr-training/[id]", () => {
  beforeEach(() => {
...
describe("PATCH /api/admin/ocr-training/[id]", () => {
  beforeEach(() => {
    getServerSessionMock.mockReset();
  });
