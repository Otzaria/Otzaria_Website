...
הקבצים `typography.css`, `layout.css`, `shape.css`, `elevation.css`, ו-`motion.css` מגדירים מחדש את טוקני ברירת המחדל של Tailwind בערכים זהים לערכים המותקנים כרגע בפרויקט. לכן הם לא משנים את המראה הקיים, אלא הופכים את העיצוב למנוהל ממקום אחד.
