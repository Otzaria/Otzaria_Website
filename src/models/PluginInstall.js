...
//
// מגבלה מתועדת: מכסה התקנה ישירה מהאתר בלבד (משתמש מחובר). התקנה ידנית של
// קובץ שהורד אינה מזוהה, ולכן היעדר רישום אינו מעיד שהתוסף לא הותקן — ולכן
// הוא גם אינו חוסם דירוג, אלא רק אינו מקנה לו את סימון האימות.
